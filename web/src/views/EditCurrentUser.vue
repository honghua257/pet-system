    ...
    <el-card>
      ...
      <el-form :model="formData" label-width="100px">
        ...
        <el-form-item label="店铺名称" prop="storeName"
          ...
          <el-input placeholder="请输入店铺名称" v-model.trim="formData.storeName" clearable>
          </el-input>
        </el-form-item>
        ...
        <el-form-item label="店铺地址" prop="storeAddress"
          ...
          <el-input placeholder="请输入店铺地址" v-model.trim="formData.storeAddress" clearable>
          </el-input>
        </el-form-item>

        <el-form-item label="店铺图片" prop="storeImg"
                      v-if="formData.type === 'PET_STORE_MANAGER'"
                      :rules="[{required:true,message:'请选择店铺图片',trigger:['blur','change']}]" style="width: 100%">
          <MyUpload type="imageCard" :limit="1" :files="formData.storeImg" @setFiles="formData.storeImg=$event"></MyUpload>
        </el-form-item>
